...
#PUNTO 1
#############################################################################################
unicef_ini <- read.csv("C:/Users/JMINCHALO/Desktop/UNICEF CURSO_AVAN/Bases en bruto/UNICEF-20_10v1.csv", 
                       header = TRUE,
                       sep = ",")
...
write.xlsx(unicef_conca, "C:/Users/JMINCHALO/Desktop/UNICEF CURSO_AVAN/Bases depuradas/UNICEF-20_10v1.xlsx")
